...
\begin{figure}[!htb]
\centering
\subfigure[$Gauss_{\sigma}(x,y)$\label{fig:Gauss}]{\includegraphics[width=0.4\textwidth]{Uebung6/Gauss.pdf}}\quad
\subfigure[$d^{2}/d\sigma,\sigma=0,5$]{\includegraphics[width=0.4\textwidth\label{fig:1Abl}]{Uebung6/1Abl_sigma.pdf}}\quad
\subfigure[$d^{2}/dx^{2}$ und $d^{2}/dy^{2},\sigma=0,5$\label{fig:2Abl}]{\includegraphics[width=0.4\textwidth]{Uebung6/2Abl_xy.pdf}}\quad
\subfigure[LoG,$\sigma=0,5$\label{fig:LoG}]{\includegraphics[width=0.4\textwidth]{Uebung6/LoG.pdf} }
\caption{Funktionen}
\end{figure}
